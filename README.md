...
#### 5.3.1 足・脚の規定
- (a)	足裏(地面に接地する部分)のサイズを規定する。 __足裏の前後の長さは、10cm以下__とする。 __足裏の左右の長さは脚の長さの5cm以下__とする。
  ただし、 __足の長さは10cm以上__とする。脚の長さとは、脚部の最上部にある、前後に動くより高い軸から足裏までの長さとし、脚を伸ばした状態で長さを計測する。
