...
#### 5.6　腕の規定 
- (a) ~~胴体から離れて動く部位（脚を除く腕、頭など）の長さは 胴体の中心から離れて動く部位の先端までの長さZを25cm以下とする。~~ __胴体から離れて動く部位（脚を除く腕、頭など）の長さは 両腕が胴体から離れて動く軸あるいは面を結ぶ直線の中点から胴体から離れて動く部位の先端までの長さZを25cm以下とする。__ 長さの計測は左右に伸ばした状態で行う。頭については10cm以下とする。なお公認ロボットの場合は公認ロボットの規格に準じる。
