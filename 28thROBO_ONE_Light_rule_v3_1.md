### 28th robo-one light rule _Ver3.1_
...
- (5)__V3.1_2025/12/10改訂(パイロンと予選一部の変更)__ 
...
### 8.1	予選ビーチフラッグバトル
- (a) 直径10cm、高さ30cmの赤い円錐形パイロンを奪い合うビーチフラッグバトルを予選として実施する。

  
- (b)3～5体（原則4体）が小型リングのレフリー指定する位置（原則４隅）からスタートし、3分間でパイロンをを奪い合い、競技時間の終了時点でパイロンを両腕で確保しているロボットを勝者とする。試合時間中、全てのロボットは自由に攻撃することができパイロンを確保したロボットから奪うことができる。競技終了時点でパイロンを確保しているロボットがいない場合、パイロンの底面に最も足裏が近いロボットを勝者とする。
